        ...
        <OwlCarousel items={2}  autoplay = {true} 
          ...
          margin= {8}>  
           ...
           <div className='test'>
            ...
            <div className='test'>
            {/* <img  className="img-test" src= {pic3}/> */}
            ...
            <div className='test'>
            <p className='testContent'>I really love to interact with Vihatha’s team. The content and experience is really transformative and rewarding. I always feel welcome in their nurturing learning environment. Interactions with the facilitators helped me to understand the basics of critical thinking, public speaking and leadership. Career counseling sessions with them made me more aware of the undergraduate colleges in India. They always encourage you to apply the insights from discussions in real life scenarios- making the learning experience all the more relevant and impactful. <br /><br /> -Sahil Shamnani, Student, 12th class</p>
            </div>
      </OwlCarousel>  
      </div>  
